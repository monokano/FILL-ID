...
//
// アプリにバンドルしたヘルプブック（FILL Id Help.help）の index.html を WKWebView で表示する。
// 表示言語はロケールに応じて ja / en を切り替える。Glow Id の HelpWindowController を流用。
...
class HelpWindowController: NSObject, WKNavigationDelegate {
    ...
    func show() {
        ...
        win.title = String(localized: "FILL Id Help")
    ...
    private func loadIndexPage(into webView: WKWebView) {
        ...
        let subdir = "FILL Id Help.help/Contents/Resources/\(lang).lproj"
